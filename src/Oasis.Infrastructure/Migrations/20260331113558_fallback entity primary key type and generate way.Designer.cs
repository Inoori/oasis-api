...
namespace Oasis.Infrastructure.Migrations
{
    ...
    [Migration("20260331113558_fallback entity primary key type and generate way")]
    partial class fallbackentityprimarykeytypeandgenerateway
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Oasis.Domain.Booking", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Oasis.Domain.Cabin", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Oasis.Domain.Guest", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Oasis.Domain.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Oasis.Domain.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Oasis.Domain.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Oasis.Domain.Booking", b =>
                {
                    b.HasOne("Oasis.Domain.Cabin", "Cabin")
                        .WithMany()
                        .HasForeignKey("CabinId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Oasis.Domain.Guest", "Guest")
                        .WithMany()
