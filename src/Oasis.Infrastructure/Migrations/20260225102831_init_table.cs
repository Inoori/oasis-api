        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    regularPrice = table.Column<short>(type: "smallint", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    countryFlag = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    numNights = table.Column<short>(type: "smallint", nullable: true),
                    numGuests = table.Column<short>(type: "smallint", nullable: true),
                    cabinPrice = table.Column<float>(type: "real", nullable: true),
                    extrasPrice = table.Column<float>(type: "real", nullable: true),
                    totalPrice = table.Column<float>(type: "real", nullable: true),
                    status = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
                    hasBreakfast = table.Column<bool>(type: "boolean", nullable: true),
                    ...
                    cabinID = table.Column<long>(type: "bigint", nullable: true),
                    guestID = table.Column<long>(type: "bigint", nullable: true),
                    cabinID1 = table.Column<long>(type: "bigint", nullable: true),
                    guestID1 = table.Column<long>(type: "bigint", nullable: true)
                },
                constraints: table =>
                {
